    ...
    data_files=[
        ...
        (
            ...
            [
                ...
                "usr/lib/systemd/system/snapborg-backup-all.timer",
                "usr/lib/systemd/system/snapborg-backup@.service",
                "usr/lib/systemd/system/snapborg-backup@.timer",
                "usr/lib/systemd/system/snapborg-prune.service",
                "usr/lib/systemd/system/snapborg-prune.timer",
            ],
        ),
    ],
    platforms=[
